...
%Intermediate proficiency in python3 (used for hackathons), Linux shell, C++. Familiar with Java, C and Intel assembly (used to complete coursework projects).
